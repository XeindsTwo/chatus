...
export function LegalDocument({ locale = 'ru' }: LegalDocumentProps) {
  const isTranslated = locale !== 'ru';
  const currentSections = isTranslated ? englishSections : sections;
    ...
    <section className="legal-document">
      <div className="legal-document__container">
        <header className="legal-document__hero">
          {isTranslated ? (
            <>
              <p>This Privacy Policy version is effective as of May 27, 2026.</p>
              <h1>Privacy Policy</h1>
              <div className="legal-document__lead">
                <p>
                  The purpose of this Policy is to inform you how MALJOY LTD processes your personal data when you use
                  the Chatus website and related services.
                </p>
                <p>
                  By accepting this Policy and using the Site, you accept its terms in full.
                </p>
              </div>
            </>
          ) : (
            <>
          <p>Действует с 27 мая 2026 г.</p>
          <h1>Политика конфиденциальности</h1>
          <div className="legal-document__lead">
            <p>
              Настоящая Политика объясняет, как MALJOY LTD обрабатывает персональные данные при использовании сайта
              Chatus и связанных с ним сервисов.
            </p>
            <p>
              Соглашаясь с Политикой и используя Сайт, вы принимаете ее условия в полном объеме.
            </p>
          </div>
            </>
          )}
        ...
        <footer className="legal-document__closing">
          {isTranslated ? (
            <>
              <p>Thank you for choosing Chatus.</p>
              <p>Respectfully, the Maljoy team</p>
            </>
          ) : (
            <>
          <p>Спасибо, что выбрали Chatus.</p>
          <p>С уважением, команда Maljoy</p>
            </>
          )}
        </footer>
      </div>
