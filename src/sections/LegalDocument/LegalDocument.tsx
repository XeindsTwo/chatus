...
const websitePrivacyHeadingPattern = /^(?:Who we are|Definitions|What data we process|Who we may share data with|Automated decisions|Cross-border transfer and storage|Data security|Your rights|How to exercise your rights|\u041a\u0442\u043e \u043c\u044b|\u041e\u043f\u0440\u0435\u0434\u0435\u043b\u0435\u043d\u0438\u044f|\u041a\u0430\u043a\u0438\u0435 \u0434\u0430\u043d\u043d\u044b\u0435 \u043c\u044b \u043e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u043c|\u041a\u043e\u043c\u0443 \u043c\u044b \u043c\u043e\u0436\u0435\u043c \u043f\u0435\u0440\u0435\u0434\u0430\u0432\u0430\u0442\u044c \u0434\u0430\u043d\u043d\u044b\u0435|\u0410\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0437\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0435 \u0440\u0435\u0448\u0435\u043d\u0438\u044f|\u0422\u0440\u0430\u043d\u0441\u0433\u0440\u0430\u043d\u0438\u0447\u043d\u0430\u044f \u043f\u0435\u0440\u0435\u0434\u0430\u0447\u0430 \u0438 \u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0435|\u0411\u0435\u0437\u043e\u043f\u0430\u0441\u043d\u043e\u0441\u0442\u044c \u0434\u0430\u043d\u043d\u044b\u0445|\u0412\u0430\u0448\u0438 \u043f\u0440\u0430\u0432\u0430|\u041a\u0430\u043a \u0440\u0435\u0430\u043b\u0438\u0437\u043e\u0432\u0430\u0442\u044c \u0441\u0432\u043e\u0438 \u043f\u0440\u0430\u0432\u0430)$/i;
...
function normalizeRepeatedText(text: string) {
  const value = text.trim();
  const midpoint = value.length / 2;

  if (Number.isInteger(midpoint) && value.slice(0, midpoint) === value.slice(midpoint)) {
    return value.slice(0, midpoint).trim();
  }
...
function isHeading(text: string) {
  const value = normalizeRepeatedText(text);
  return !agreementMinorHeadingPattern.test(value)
    ...
    && (
      ...
      || websitePrivacyHeadingPattern.test(value)
...
function renderBlock(block: LegalBlock, index: number) {
  if (block.type === 'paragraph') {
    const normalizedText = normalizeRepeatedText(block.text);

    if (isSubheading(normalizedText)) {
      const subheading = normalizedText.replace(/[;:]+$/, '');
      return <h3 className="legal-document__subheading" key={index}>{renderText(subheading)}</h3>;
    }
    return isHeading(normalizedText)
      ? <h2 key={index}>{renderText(normalizedText)}</h2>
...
function renderBlocks(blocks: LegalBlock[]) {
  ...
  blocks.forEach((block, index) => {
    const blockText = block.type === 'paragraph' ? normalizeRepeatedText(block.text) : '';
