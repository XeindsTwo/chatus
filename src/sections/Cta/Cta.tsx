    ...
    <section className="cta">
      <div className="cta__container">
        <h2 className="cta__title section-title">
          {isEnglish ? 'Find someone' : 'Найдите своего'}
          <br />
          {isEnglish ? 'to chat with' : 'собеседника'}
          <br />
          {isEnglish ? 'right now' : 'уже сейчас'}
        </h2>

        <div className="cta__animation" aria-label={isEnglish ? 'Chat partners animation' : 'Анимация собеседников'} ref={animationRef}>
          <DotLottieReact
            autoplay={false}
        ...
        <Button className="cta__button" href="https://t.me/chatusbot" target="_blank" rel="noreferrer">
          ...
          {isEnglish ? 'Start chatting' : 'Найти собеседника'}
        </Button>
      </div>
    </section>
  );
